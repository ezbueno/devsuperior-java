 ...
 * valor de depósito inicial, entretanto, é opcional, ou seja: se o titular não tiver dinheiro para
 * depositar no momento de abrir a sua conta, o depósito inicial não será feito e o saldo inicial
 ...
 * por exemplo).
 * 
 * Por fim, o saldo da conta não pode ser alterado livremente. É preciso ver um mecanismo para proteger
 ...
 * 
 * Você deve fazer um programa que realize um cadastro de uma conta, dando opção para que seja ou não
