 ...
 * ainda que a pessoa terá que pagar 6% de IOF sobre o valor em dólar. Criar uma classe CurrencyConverter
...
public class Program {
	public static void main(String[] args) {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			double result = CurrencyConverter.converterFromDollarsToReais(currencyPrice, amount);
